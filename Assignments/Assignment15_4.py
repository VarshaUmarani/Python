...
# Log file should be created into current directory. Display execution time required for the script.
...
def main():
	...
	end_time = time.time()
	print(f"Total time of execution of above Python script is : {(end_time - start_time):.03f} milliseconds")
